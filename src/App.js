...
const projects = [{
    ...
    },
    {
      ...
      "about": "Storybook Maker is one of my favorite single page apps. I wanted to easily make fun stories/book pages that friends could add to, so I came up with this idea. This app employs JavaScript and Rails for users to create their own custom stories with pictures. I developed a Rails backend database to store book data submitted by the user and built the frontend using JavaScript DOM manipulation and HTML. I implemented full CRUD for interacting with the books, so users can create a new book, delete a book, and edit a book. They also had the option to sort through all the books by book title, author name, and the books that they created. It was designed with BootStrap and CSS to show modal pop-ups, the navbar, and other user interface features.",
